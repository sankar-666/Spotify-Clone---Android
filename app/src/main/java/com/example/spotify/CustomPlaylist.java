...
public class CustomPlaylist extends ArrayAdapter<String>  {
	...
	private String[] number;
	 ...
	 public CustomPlaylist(Activity context, String[] n) {
	        //constructor of this class to get the values from main_activity_class

	        super(context, R.layout.cust_playlist,n);
	    ...
	    public View getView(int position, View convertView, ViewGroup parent) {
	        ...
	        View listViewItem = inflater.inflate(R.layout.cust_playlist, null, true);
