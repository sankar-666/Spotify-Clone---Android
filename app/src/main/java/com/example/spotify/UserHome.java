...
public class UserHome extends AppCompatActivity implements JsonResponse, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGridView = findViewById(R.id.horizontal_gridview);
            ...
            if(method.equalsIgnoreCase("viewcategory")){
                ...
                if(status.equalsIgnoreCase("success")){
                    ...
                    for(int i = 0;i<ja1.length();i++)
                    {
                        ...
                        img[i]=ja1.getJSONObject(i).getString("img");
...
//                    l1.setAdapter(clist);
                    ...
                    CustomUser adapter = new CustomUser(this, cat,img);
